...
CKEDITOR.lang['ru'] = {
	...
	"fontawesomeDialog": {
		"insertFontawesome": "Вставить иконку Fontawesome",
		"colorChooser": "Цвет",
		"button": "Выбрать",
		"size": "Размер в пикселях",
		"spinning": "Вращающийся",
		"fixedWidth": "Фиксированая ширина",
		"bordered": "В рамке",
		"Flip Vertical": "Вертикальное вращение",
		"Flip Horizontal": "Горизонтальное вращение",
		"Rotate 270": "Поворот 270",
		"Rotate 180": "Поворот 180",
		"Rotate 90": "Поворот 90",
		"Normal": "Проверка орфографии завершена. Изменено одно слово",
		"flippedRotation": "Вращение и поворот",
		"alternativeDescription": "ALT значение",
		"fontawesomeSearch": "Поиск"
	}
};