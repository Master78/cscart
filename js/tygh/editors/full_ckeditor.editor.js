...
(function(_, $) {
    ...
    $.ceEditor('handlers', {
        ...
        run: function(elm, params) {
            CKEDITOR_BASEPATH = _.current_location + '/js/addons/master_full_ckeditor/lib/ckeditor/';
            
            if (typeof(window.CKEDITOR) == 'undefined') {
                $.ceEditor('state', 'loading');
                return $.getScript('js/addons/master_full_ckeditor/lib/ckeditor/ckeditor.js', function() {
